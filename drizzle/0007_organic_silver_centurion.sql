ALTER TABLE "client_message" ADD COLUMN IF NOT EXISTS "direct_owner_id" varchar(255);--> statement-breakpoint
ALTER TABLE "client_message" ADD COLUMN IF NOT EXISTS "direct_friend_id" varchar(255);--> statement-breakpoint
DO $$ BEGIN
